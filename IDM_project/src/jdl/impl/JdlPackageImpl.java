...
public class JdlPackageImpl extends EPackageImpl implements JdlPackage {
	...
	public void createPackageContents() {
		...
		createEAttribute(configEClass, CONFIG__DATA_BASE_TYPE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getConfig_BaseName(), ecorePackage.getEString(), "baseName", null, 0, 1, Config.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getConfig_AppType(), ecorePackage.getEString(), "appType", null, 0, 1, Config.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getConfig_PackageName(), ecorePackage.getEString(), "packageName", null, 0, 1, Config.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getConfig_DataBaseType(), ecorePackage.getEString(), "dataBaseType", null, 0, 1, Config.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
