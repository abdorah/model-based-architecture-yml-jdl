 ...
 * </p>
 * <ul>
 *   <li>{@link test.impl.ApplicationImpl#getConfig <em>Config</em>}</li>
 *   <li>{@link test.impl.ApplicationImpl#getEntity <em>Entity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApplicationImpl extends MinimalEObjectImpl.Container implements Application {
	...
	protected EClass eStaticClass() {
		return TestPackage.Literals.APPLICATION;
	}
	...
	public EList<Config> getConfig() {
		if (config == null) {
			config = new EObjectContainmentEList<Config>(Config.class, this, TestPackage.APPLICATION__CONFIG);
		}
		return config;
	}
	...
	public EList<Entity> getEntity() {
		if (entity == null) {
			entity = new EObjectContainmentEList<Entity>(Entity.class, this, TestPackage.APPLICATION__ENTITY);
		}
		return entity;
	}
