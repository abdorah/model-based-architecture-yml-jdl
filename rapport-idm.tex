...
\include{chapters/Objectifs&DescriptionFoncitionnelle.tex}	

\chapter*{Description des méta-modèles}
\fancyhead[L]{\textbf{Chapitre: Description des méta-modèles}}
\fancyhead[R]{\hspace*{5cm}}
\include{chapters/DescriptionMetaModels.tex}	
...
\fancyhead[R]{\hspace*{5cm}}
\include{chapters/DescriptionEntreeTransformationSortie.tex}	
