...
/**
 * This is the item provider adapter for a {@link yml.Leaf} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LeafItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Leaf_applicationName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Leaf_applicationName_feature", "_UI_Leaf_type"),
				 YmlPackage.Literals.LEAF__APPLICATION_NAME,
				 true,
				 false,
				 false,
	...
	protected void addApplicationTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Leaf_applicationType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Leaf_applicationType_feature", "_UI_Leaf_type"),
				 YmlPackage.Literals.LEAF__APPLICATION_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDatabaseTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Leaf_databaseType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Leaf_databaseType_feature", "_UI_Leaf_type"),
				 YmlPackage.Literals.LEAF__DATABASE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPackageNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Leaf_packageName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Leaf_packageName_feature", "_UI_Leaf_type"),
				 YmlPackage.Literals.LEAF__PACKAGE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Leaf)object).getApplicationName();
